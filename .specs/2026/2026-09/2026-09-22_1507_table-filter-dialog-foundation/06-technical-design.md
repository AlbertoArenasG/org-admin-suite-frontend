...
- Una URL con varios rangos heredados no se proyecta como un período ficticio:
  ...
  nuevo período único o limpiar deliberadamente.
...
| Contenedor CSR                     | contenedor de módulo    | `src/components/customer-service-records/CustomerServiceRecordsTableContainer.tsx` | Adaptar confirmación del diálogo y reset de página                            | Zustand, thunk, URL                         | modify         |
