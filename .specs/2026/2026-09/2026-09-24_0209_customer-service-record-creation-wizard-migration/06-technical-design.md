...
Se eliminan `src/app/dashboard/customer-service-records/new/page.tsx` y la
entrada `customerServiceRecordsCreate` de definicion, tipos y visibilidad de
navegacion. Ninguna ruta nueva reemplaza ese URL; el boton de toolbar es la
entrada de creacion.
...
| ruta legacy de alta       | ruta legacy           | `src/app/dashboard/customer-service-records/new/page.tsx`                            | Se elimina: alta pasa al dialogo.                  | Form legacy.                   | modify         |
