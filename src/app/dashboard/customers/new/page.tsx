  ...
  return (
    <div className="flex flex-1 flex-col gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <PageBreadcrumbs
            segments={[
              ...
              {
                label: t('customers.create.breadcrumb'),
              },
            ]}
          />
        </div>
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-semibold tracking-tight">{t('customers.create.title')}</h1>
        <p className="text-muted-foreground">{t('customers.create.subtitle')}</p>
      </div>

      <Card className="rounded-3xl border border-border/70 bg-card/90 shadow-md">
        <CardHeader>
          <CardTitle>{t('customers.create.formTitle')}</CardTitle>
          <CardDescription>{t('customers.create.formSubtitle')}</CardDescription>
        </CardHeader>
        <CardContent>
