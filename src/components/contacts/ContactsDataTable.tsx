...
import { ContactsTableToolbar } from '@/components/contacts/ContactsTableToolbar';
import { ContactsDeleteDialog } from '@/components/contacts/ContactsDeleteDialog';
...
export function ContactsDataTable({
  ...
  return (
    ...
    >
      ...
      <ContactsDeleteDialog {...deleteDialog} />
    </Paper>
  );
}
