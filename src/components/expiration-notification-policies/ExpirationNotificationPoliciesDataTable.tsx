...
import { ExpirationNotificationPoliciesTableToolbar } from '@/components/expiration-notification-policies/ExpirationNotificationPoliciesTableToolbar';
...
interface ExpirationNotificationPoliciesDataTableProps {
  ...
  deleteDialog: {
    open: boolean;
    policy: ExpirationNotificationPoliciesTableRow | null;
...
export function ExpirationNotificationPoliciesDataTable({
  table,
  isLoading,
  error,
  onCreateClick,
  ...
  deleteDialog,
  tableLabels,
}: ExpirationNotificationPoliciesDataTableProps) {
  return (
    <Paper
      elevation={0}
      sx={{
    ...
    >
      ...
      <ExpirationNotificationPoliciesTableToolbar
        table={table}
      ...
      <ExpirationNotificationPoliciesDeleteDialog {...deleteDialog} />
    </Paper>
  );
}
