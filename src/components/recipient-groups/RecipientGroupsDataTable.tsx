...
import { RecipientGroupsTableToolbar } from '@/components/recipient-groups/RecipientGroupsTableToolbar';
import { RecipientGroupsDeleteDialog } from '@/components/recipient-groups/RecipientGroupsDeleteDialog';

interface RecipientGroupsDataTableProps {
...
export function RecipientGroupsDataTable({
  table,
  isLoading,
  error,
  onCreateClick,
  ...
  return (
    ...
    >
      ...
      <RecipientGroupsDeleteDialog {...deleteDialog} />
    </Paper>
  );
}
