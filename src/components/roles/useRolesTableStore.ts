...
interface RolesTableStoreState {
...
interface RolesTableStoreActions {
...
export type RolesTableStore = RolesTableStoreState & RolesTableStoreActions;
...
function createInitialState(): RolesTableStoreState {
  return {
...
export const useRolesTableStore = create<RolesTableStore>((set) => ({
  ...createInitialState(),
  ...
  syncFromUrl: (nextState) => {
    ...
    set((state) => {
      const updates: Partial<RolesTableStoreState> = {};
