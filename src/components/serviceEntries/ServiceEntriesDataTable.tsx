...
import { ServiceEntriesTableToolbar } from '@/components/serviceEntries/ServiceEntriesTableToolbar';
import { ServiceEntriesDeleteDialog } from '@/components/serviceEntries/ServiceEntriesDeleteDialog';

interface ServiceEntriesDataTableProps {
...
export function ServiceEntriesDataTable({
  table,
  isLoading,
  error,
  onCreateClick,
  ...
  return (
    ...
    >
      ...
      <ServiceEntriesDeleteDialog {...deleteDialog} />
    </Paper>
  );
}
