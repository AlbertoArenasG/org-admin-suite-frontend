...
export const SharkCheckbox = (props: React.ComponentProps<typeof ArkCheckbox.Root>) => {
  const { className, tabIndex, ...rest } = props;

  return (
    <ArkCheckbox.Root
      className={cn(checkboxVariants(), className)}
      data-slot="shark-checkbox"
      role="checkbox"
      {...rest}
    >
      <ArkCheckbox.Control data-slot="shark-checkbox-control">
        <CheckboxIndicator>
          <CheckIcon />
        </CheckboxIndicator>
...
export const CheckboxIndicator = (props: React.ComponentProps<typeof ArkCheckbox.Indicator>) => {
  ...
  return (
    <ArkCheckbox.Indicator
      ...
      data-slot="shark-checkbox-indicator"
      {...rest}
    />
  );
};
